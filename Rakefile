...
import "#{spec.gem_dir}/lib/tasks/geo_combine.rake"
...
task :harvest do |t, args|
  # Explicitly invoke the dependency with the captured argument
  Rake::Task['geocombine:geoblacklight_harvester:index'].invoke('earthworks')

  puts "Pipeline executed successfully."
end
